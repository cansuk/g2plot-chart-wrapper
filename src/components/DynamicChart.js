...
import { Line, Bar, Pie, Area, Column, DualAxes, BidirectionalBar, G2, Radar, RadialBar } from '@ant-design/charts';
...
const DynamicChart = (props) => {
    ...
    debugger;
    return <div>hello from dynamic charts</div>
    // let { templateName, style, dataGridState, onSaveChartSettings, item, settings, isDashboard, chartName } = props;
